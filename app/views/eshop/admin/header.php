...
<!--This file is header of admin section-->
...
<section id="container">
    ...
    *********************************************************************************************************************************************************** -->
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="index.php#">
                                <span class="photo"><img alt="avatar"
                                                         src="<?= ASSETS . THEME ?>admin/img/ui-zac.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="index.php#">
                                <span class="photo"><img alt="avatar"
                                                         src="<?= ASSETS . THEME ?>admin/img/ui-sherman.jpg"></span>
                                <span class="subject">
    ...
    <!-- LogOut and redirect to index of webpage shop-->
        <div class="top-menu">
