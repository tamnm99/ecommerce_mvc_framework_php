        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <?php if ($ROW) : ?>
                    <div class="product-details"><!--product-details-->
                        ...
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                <img src="<?= ASSETS . THEME ?>images/product-details/new.jpg" class="newarrival"
                                     alt=""/>
                                ...
                                <a href="<?= ROOT ?>add_to_cart/<?= $ROW->id ?>" class="btn btn-default add-to-cart"><i
                                            class="fa fa-shopping-cart"></i>Thêm vào Giỏ</a>
                                <p><b>Tình Trạng:</b> Còn Hàng</p>
                                <p><b>Loại Hàng:</b> Mới</p>
                                <p><b>Thương Hiệu:</b> E-SHOPPER</p>

                                <img src="<?= ASSETS . THEME ?>images/product-details/share.png"
                            ...
                            <div class="tab-pane fade active in" id="reviews">
                                <div class="col-sm-12">
                                    ...
                                    <form action="#">
                                        ...
                                        <b>Rating: </b> <img
                                                src="<?= ASSETS . THEME ?>images/product-details/rating.png"
                                                alt=""/>
                    ...
                    <!-- else show notification:Sản phẩm không tồn tại -->
                <?php else : ?>
                    <div style="background-color: grey; color:white; margin-bottom: 200px; text-align: center">
